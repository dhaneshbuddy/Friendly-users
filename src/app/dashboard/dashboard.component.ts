...
export class DashboardComponent {
  ...
  // ====== KPI CARDS (dummy) ======
  kpis: Kpi[] = [
    { title: 'Budget',         value: '₹24k',  subtext: '↑ 12%  Since last month', up: true,  icon: '₹', color: 'rgba(11, 73, 114, 1)' },
    { title: 'Total Customers', value: '1.6k',  subtext: '↓ 16%  Since last month', up: false, icon: '👥', color: '#54d449ff' },
    { title: 'Task Progress',   value: '75.5%', subtext: '',                        up: undefined, icon: '📋', color: '#FFA000' },
    { title: 'Total Profit',    value: '₹15k',  subtext: '',                        up: undefined, icon: '💬', color: 'rgba(11, 73, 114, 1)' },
  ];
  ...
  traffic = [
    { label: 'Direct',   value: 45, color: 'rgba(11, 73, 114, 1)' },
    { label: 'Referral', value: 25, color: '#FFA000' },
    { label: 'Social',   value: 15, color: '#54d449ff' },
    { label: 'Email',    value: 15, color: '#42A5F5' }
  ];
